...
export default function Home() {
  ...
  return <div className="site-shell" id="home">
    ...
    <main>
      ...
      <section className="reel-section section-pad reveal-section" data-reveal id="gallery"><div className="reel-heading"><p className="eyebrow">A CLOSER LOOK</p><h2>See it<br /><em>come together.</em></h2><p>Real spaces. Real materials. A glimpse into the details that make a piece feel like yours.</p></div><div className="video-reel">{videos.map((video, index) => <div className="video-tile reveal-card" data-reveal key={video}><video src={video} muted loop autoPlay playsInline /><div className="video-top"><span>0{index + 1}</span><span>SPR / REEL</span></div><span className="play-mark"><Play size={14} fill="currentColor" /></span></div>)}</div></section>
